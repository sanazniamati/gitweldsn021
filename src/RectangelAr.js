...
function RectangelAr({ shapeProps, isSelected, onSelect, onChange, color }) {
  ...
  return (
    <React.Fragment>
      <Line
        ...
        stroke={"darkgreen"}
        points={[
          124, 139, 176, 114, 272, 112, 334, 139, 306, 156, 278, 166, 257, 181,
          254, 222, 230, 252, 206, 202, 204, 172,
        ]}
        tension={0.4}
        fill={color}
        onClick={onSelect}
